...
/**
 * Paleta Usecortex — alinhada 1:1 com o brandbook oficial (maio/2026).
 * Espelho exato do `web/tailwind.config.ts` para garantir consistência visual
 * entre o app do escritório e o app do cliente final.
 *
