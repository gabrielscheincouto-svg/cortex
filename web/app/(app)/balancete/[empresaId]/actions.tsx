    ...
    <div className="space-y-5">
      ...
      <div className="rounded-xl border border-black/10 bg-white p-5">
        ...
        <div className="mt-4 grid grid-cols-1 gap-2 md:grid-cols-2 xl:grid-cols-3">
          {balancetes.map(b => (
            <div key={b.id} className="rounded-lg border border-black/10 p-3 transition hover:bg-ink-50">
              <Link href={`/balancete/${empresaId}/${b.competencia}`} className="block">
              ...
              <div className="mt-2 border-t border-black/5 pt-2">
                <Link
                  href={`/balancete/${empresaId}/auditoria/${b.competencia}`}
