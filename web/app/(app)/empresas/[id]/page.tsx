...
import { ArrowLeft, Building2, CalendarClock, ClipboardList, FileText, KeyRound, Mail, Phone, Users, type LucideIcon } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        {['admin','gerente'].includes(ctx.my_role) && (
          <div className="flex flex-wrap gap-2 lg:flex-col lg:items-end">
            <Link
              href={`/empresas/${empresa.id}/clientes`}
              className="inline-flex items-center gap-2 rounded-lg bg-mind-500 px-3 py-2 text-xs font-medium text-white shadow-sm hover:bg-mind-600"
            >
              <KeyRound size={14} /> Acessos do cliente
            </Link>
            <p className="text-[11px] text-ink-400 lg:max-w-[180px] lg:text-right">
              Convidar pessoas dessa empresa pro portal.
            </p>
          </div>
        )}
      </div>
